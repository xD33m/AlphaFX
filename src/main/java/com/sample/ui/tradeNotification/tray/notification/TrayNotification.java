...
public final class TrayNotification {
    ...
    private void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getClassLoader().getResource("img/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getClassLoader().getResource("img/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getClassLoader().getResource("img/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getClassLoader().getResource("img/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getClassLoader().getResource("img/error.png");
                paintHex = "#CC0033";
                break;
